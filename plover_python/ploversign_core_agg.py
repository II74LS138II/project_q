...
class PloverSign:
    ...
    def __init__(self,  bitsec,
        ...
        self.name   =   f'Plover_agg-{bitsec}-{d}'
        self.bitsec =   bitsec
        self.d      =   d
        self.q      =   q
...
#            print(f"c1 in sign function:{c1}")
 ...
 #           print(f"z3 in sign function:{z3}")
    ...
    def verify_msg_agg(self, b, a, u, z2, z3,n_node):
        """Verification procedure of Plover (core: verifies msg)."""
        ...
        if self._check_bounds(u, a, b, z2, z3,n_node) == False:
            return False
...
#    print(f"len of z3s_agg:{len(z3s_agg)}")
    ...
    print("=== Verify ===")
    rsp = iut_agg.verify_msg_agg(bs_agg, as_agg, u_agg, z2, z3, node_num)
    print(rsp)
    assert(rsp is True)
